 ...
 * 
 */
public class GiftImportAlert {

	public static final int INFO = 1;
	public static final int WARN = 2;
	public static final int ERROR = 3;
	public static final String GROUP_NOT_EXISTS = "##GROUP_NOT_EXISTS";
	public static final String GIFT_NOT_EXISTS = "##GIFT_NOT_EXISTS";
	...
	public static final String MISS_GIFT_TYPE = "##MISS_GIFT_TYPE";
	...
	public static GiftImportAlert error(String no2, String name,
			String spec, String string) {
		GiftImportAlert p = new GiftImportAlert();
		p.no = no2;
		p.spec = spec;
		p.message = string;
		p.type = ERROR;
	...
	public static GiftImportAlert warn(String no2, String name,
			String spec, String string) {
		GiftImportAlert p = new GiftImportAlert();
		p.no = no2;
		p.spec = spec;
	...
	public static GiftImportAlert info(String no2, String name,
			String spec, String string) {
		GiftImportAlert p = new GiftImportAlert();
		p.no = no2;
		p.spec = spec;
