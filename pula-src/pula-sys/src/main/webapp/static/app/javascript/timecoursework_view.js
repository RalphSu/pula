var PPage = new Class({
		...
		showPic  : function(p,id){
			//put to ui 
			$$(".photo a img").set('src',pageVars.base+"/app/image/icon?fp="+encodeURIComponent( p  ) +"&id="+id+"&sub="+'timecourswork');
		},
...
//				window.open( pageVars.base+'/app/timecoursework/file?id='+dataId+'&fp='+encodeURIComponent( data) ) ;
//
//			});
//
