var PPage = new Class({
		...
		initViewTable : function(){
			...
			var cfgs = {
				...
				columns: [
					...
					{label:'学生数',key:'studentCount',width:80,align:'right'},
					...
					{label:'管理',width:40,key:'id',formatter:TTable.formatLinkJs.bind({func:'pes.manage',label:'管理'}),align:'center'},
				]
			};
		...
		manage : function(id ){
		var url = encodeURIComponent('../coursesession/manage?id='+id);
