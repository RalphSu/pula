	...
	<div id="inputPanel" class="l h">
			...
			<div class="l">
				<table border="0" class="grid" width="700">
					...
					<tr>
						...
						<td><input type="text" name="course.no" id="course.no"
							size="20" maxlength="40" /></td>
						<td>课程编号<span class="redStar">*</span></td>
						<td><input type="text" name="course.courseNo"
							id="course.courseNo" size="20" maxlength="40" /></td>
					</tr>
		...
		<td ><input type="text" name="course.buyType" id="course.buyType" size="20" maxlength="10"  class="numberEdit" /></td> -->
					...
					<tr>
						...
						<td><input type="text" name="course.orderStatus"
							id="course.orderStatus" size="20" maxlength="40"
							class="numberEdit" /></td>
					</tr>
...
<script type="text/javascript"
	src="${base}/static/app/javascript/time_course_order.js"></script>
<script type="text/javascript"
