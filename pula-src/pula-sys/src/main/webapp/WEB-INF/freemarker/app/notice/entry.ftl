			...
			<div class="l">
				<table border="0" class="grid" width="700">
					...
					<tr>
						...
						<td colspan="3"><input type="text" name="course.no"
							id="course.no" size="20" maxlength="40" /></td>
					</tr>
					<tr>
						<td>标题<span class="redStar">*</span></td>
						<td colspan="3"><input type="text" name="course.title"
							id="course.title" size="60" maxlength="40" /></td>
					</tr>
					<tr>
						<td>格式化标题<span class="redStar"></span></td>
						<td colspan="3"><input type="text"
							name="course.formattedTitle" id="course.formattedTitle" size="60"
							maxlength="40" /></td>
					</tr>

					<tr>
						<td>内容</td>
						<td colspan="3"><textarea name="course.content"
								id="course.content" cols="50" rows="10"></textarea></td>
					</tr>

					<tr>
						<td>价格</td>
						<td colspan="1"><input type="text" name="course.noticePrice"
							id="course.noticePrice" size="12" class="numberEdit">
					</tr>

					<tr>
						<td>备注</td>
						<td colspan="3"><input type="text" name="course.comment"
							id="course.comment" size="60" maxlength="80" /></td>
					</tr>
					<tr>
...
<script type="text/javascript"
	src="${base}/static/app/javascript/notice.js"></script>
<script type="text/javascript"
...
<!-- editor -->
<link rel="stylesheet" type="text/css"
	href="${base}/static/library/yui/yui_2.8.1/build/assets/skins/sam/skin.css"></link>
<script src="${base}/static/library/yui/yui_2.8.1/build/yahoo/yahoo.js"></script>
<!-- Utility Dependencies -->
<script type="text/javascript"
	src="${base}/static/library/yui/yui_2.8.1/build/yahoo-dom-event/yahoo-dom-event.js"></script>
<script type="text/javascript"
	src="${base}/static/library/yui/yui_2.8.1/build/element/element-min.js"></script>
<!-- Needed for Menus, Buttons and Overlays used in the Toolbar -->
<script type="text/javascript"
	src="${base}/static/library/yui/yui_2.8.1/build/container/container_core-min.js"></script>
<script type="text/javascript"
	src="${base}/static/library/yui/yui_2.8.1/build/menu/menu-min.js"></script>
<script type="text/javascript"
	src="${base}/static/library/yui/yui_2.8.1/build/button/button-min.js"></script>
<!-- Source file for Rich Text Editor-->
<script type="text/javascript"
	src="${base}/static/library/yui/yui_2.8.1/build/editor/editor-min.js"></script>
<script type="text/javascript"
	src="${base}/static/library/yui/yui_2.8.1/build/editor/simpleeditor-min.js"></script>
