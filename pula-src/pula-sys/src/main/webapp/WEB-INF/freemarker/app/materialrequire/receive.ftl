	...
	<col />
	  ...
	  <tr> 
	   ...
	   <tr class="title"> 
		 ...
		 <tr>
		<td >接收数量<span class="redStar">*</span></td>
		<td colspan="5"><input type="text" name="quantity" id="quantity" size="10" maxlength="10" class="numberEdit" value="0"/><span id="spanUnit"></span> </td>
	  </tr> 
	  <tr> 
		<td colspan="6">
...
<script type="text/javascript" src="${base}/static/app/javascript/materialrequire_receive.js"></script>
