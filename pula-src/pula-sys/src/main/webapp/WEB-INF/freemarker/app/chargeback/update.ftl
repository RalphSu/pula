  ...
  <tr class="title"> 
   ...
   <tr> 
	...
	<tr><td>辅助教师</td>
		...
		<td colspan="2"><input type="text" id="form.points" size="10" class="numberEdit view" value='0' /> </td>
	</tr>
	<tr>
		<td>备注</td>
		<td colspan="3">
	...
	<tr><td>退课数</td>
	<td><input type="text" name="form.backCourses" id="form.backCourses" class="numberEdit" maxlength="10" style="width:40px" value="0"/>

	<span>可退数量:${orderForm.courseCount-orderForm.consumeCourseCount}</span>
	</td><td>退款金额</td>
	<td colspan="2"><input type="text" name="form.backAmount" id="form.backAmount"  class="numberEdit" maxlength="10" style="width:60px" value="0"/>
	...
	<tr>
		<td>备注</td>
		<td colspan="3">
		<div class="l"><input type="text"  id="form.comments" name="form.comments" size="60" maxlength="100">
		</div><div class="r prepay-ui" >余额</div>
		</td>
		<td>
		<div class="prepay-ui numberEdit" id="divLeftPrice" style="width:80px"></div>
	 ...
	 <tr> 
		...
		<input type="hidden" name="form.orderFormId" id="form.orderFormId" value="${orderForm.id}"/>
		</div>
		<div class="r">
			ALT+S 保存
		</div>
...
<script type="text/javascript" src="${base}/static/app/javascript/chargeback_update.js"></script>
...
var lang = {
	name:'名称',no:'编号',domain:'<#if cbUpdateMode>修改<#else>新增</#if>退单',
	materialNo:'材料编号',
