...
<div class="body">
	...
	<table border="0" class="grid" width="850">
	...
	<col />
	  ...
	  <tr class="title"> 
		...
		<td ><input type="text" name="quantity" id="quantity" size="10" maxlength="10" class="numberEdit" value="0"/><span id="spanUnit"></span> </td>
	 
		<td >备注</td>
		<td colspan="3"><input type="text" name="comments" id="comments" size="60" maxlength="100"/> </td>
	  </tr> 
	  <tr> 
		<td colspan="6">
		<div class="l"><input type="submit" value="受理" id="submitBtn" style="color:green" accesskey="s"/>
		<input type="button" value="驳回" id="rejectBtn" style="color:red;font-weight:bold;margin-left:40px" accesskey="c"/>
		<input type="hidden" name="objId" id="materialRequire.id"/></div>
		<div class="r">alt+s 受理 alt+c 驳回</div>
		<div class="c"></div>
		</td>
	  </tr> 
	</table>
...
<script type="text/javascript" src="${base}/static/app/javascript/materialrequire_apply.js"></script>
