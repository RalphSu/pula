package pula.sys.wechat.pay.util;

public class ConstantUtil {
	/**
	 * 商家可以考虑读取配置文件 -- 放入系统的配置项，方便动态改变
	 */

	// 初始化
	public static String APP_ID = "wx90816ac92bb628a7";// 微信开发平台应用id
	public static String APP_SECRET = "1bf73544f2617cea8ba06a1d259564d1";// 应用对应的凭证
	public static String PARTNER = "1277147701";// 财付通商户号
	public static String PARTNER_KEY = "Smjx1tdhSmjx1tdhSmjx1tdhSmjx1tdh";// 商户号对应的密钥
