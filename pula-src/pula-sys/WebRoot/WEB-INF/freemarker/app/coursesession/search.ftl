...
<script type="text/javascript" src="${base}/static/app/javascript/coursesession_search.js"></script>
...
var lang = {
	name:'名称',no:'编号',domain:'授课记录查询',expiredTime:'失效日期',publishTime:'发布日期',showInWeb:'显示在网站上',indexNo:'序号',
