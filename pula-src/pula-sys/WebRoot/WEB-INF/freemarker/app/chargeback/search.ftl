...
<script type="text/javascript" src="${base}/static/app/javascript/chargeback_search.js"></script>
...
var lang = {
	name:'名称',no:'编号',domain:'退单查询',gender:'性别',status:'状态',print:'打印条码',printOK:'选中项已成功输出打印',file:'档案'
