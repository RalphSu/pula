...
<script type="text/javascript" src="${base}/static/app/javascript/stocklog.js"></script>
...
var lang = {
	name:'名称',no:'编号',domain:'材料库存日志',materialNo:'材料编号',materialName:'材料名称',warehouse:'仓库',space:'区域',quantity:'数量',no:'内单号',outNo:'外单号'
