...
<table border="0" class="grid" width="100%">
  <tr class="title"> 
    <td >用户组信息:${group.no?if_exists?html}(${group.name?if_exists?html}) </td>
  </tr>

  
</table>
<div style="position: absolute;top:260px;left:5px;height:20px;width:100px;visibility:visible;font-size:9pt;background-color:#FFCC00;border:1px #ccc solid" id="loading"><B><@b.text key="platform.sysUser.loading"/>...</B>
</div>
