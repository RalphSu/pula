...
<div class="body">
	...
	<col />
	  ...
	  <tr class="title"> 
            <td colspan="4"><div class="l">受理申请 <span id="pageMode" style="color:blue" class="h"></span></div>
              <div class="r">
	 ...
	 <tr> <td >IP</td>
	  ...
	  <tr class="title"> 
	   ...
	   <tr> 
		<td >受理结果 <span class="redStar">*</span></td>
		<td colspan="3">
...
<script type="text/javascript" src="${base}/static/app/javascript/courseclient_apply.js"></script>
...
var lang = {
	name:'名称',no:'编号',domain:'开课客户端申请受理',gender:'性别',status:'状态',print:'打印条码',printOK:'选中项已成功输出打印',file:'档案'
