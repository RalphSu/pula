...
<script type="text/javascript" src="${base}/static/app/javascript/giftstockevent.js"></script>
...
var lang = {
	name:'名称',no:'编号',domain:'${pageVars.title!?html}',giftNo:'礼品编号',giftName:'礼品名称',warehouse:'仓库',space:'区域',quantity:'数量',no:'内单号',outNo:'外单号'
