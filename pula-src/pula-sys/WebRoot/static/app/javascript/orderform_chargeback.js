var PPage = new Class({
		...
		initViewTable : function(){
			...
			var cfgs = {
				...
				columns: [
					...
					{label:'创建退单',width:80,key:'id',formatter:TTable.formatLinkJs.bind({func:'pes.view',label:'创建退单'}),align:'center'}
				]
			};
	...
	updatePage : function(id ){
		...
		var url = encodeURIComponent('../orderform/view4chargeback?id='+id);
