...
import pula.web.controllers.http.JsonResultCourseMix;
import pula.web.controllers.http.JsonResultPointsMix;
import pula.web.controllers.http.JsonResultWithMap;
import pula.web.controllers.http.PostParameter;
import pula.web.controllers.http.Response;
import pula.web.miscs.MD5Checker;
...
public class StudentService {
	...
	pula.web.controllers.http.HttpClient client = new pula.web.controllers.http.HttpClient();
