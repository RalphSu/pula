...
<link rel="stylesheet" type="text/css" href="${base}/static/student/css/index.css">
...
<div id="container_wrapper">
	...
	<div id="userInfoDiv">@ ${_sess.getProps("S_BRANCH").name!?html}</div>
		<a href="${base}/student/points/entry" id="btnMyPoints"/></a>
		<a href="${base}/student/course/entry" id="btnMyCourse"/></a>
		<a href="${base}/student/course/stat" id="btnMyStat"/></a>
