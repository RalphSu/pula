...
namespace SendCard
{
    public class CardConfig
    {
        ...
        public void LoadFromFile()
        {
            ...
            Username = iniFile.ReadString("main", "username", "");
            string pwd = iniFile.ReadString("main", "password", "");
            if (!string.IsNullOrEmpty(pwd))
            {
                Password = DesUtils.Decode(pwd);
            }
            else
            {
                Password = "";
        ...
        public void SaveToFile()
        {
            ...
            iniFile.WriteString("main", "username", Username);
            iniFile.WriteString("main", "password",DesUtils.Encode(Password));
