...
import com.yuhj.ontheway.adapter.ZhuantiImageDetailsAdapter;
...
public class ZhuantiDetailImageActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		LoadingAinm.ininLoding(ZhuantiDetailImageActivity.this);
			...
			if (result != null) {
				...
				gridView.setOnItemClickListener(new OnItemClickListener() {
					...
					public void onItemClick(AdapterView<?> arg0, View arg1,
						...
						// TODO Auto-generated method stub
						Intent intent = new Intent(ZhuantiDetailImageActivity.this,
